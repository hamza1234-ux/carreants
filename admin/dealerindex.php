<?php  include('dealercon.php'); ?>
<?php 
	if (isset($_GET['edit'])) {
		$id = $_GET['edit'];
		$update = true;
		$record = mysqli_query($db, "SELECT * FROM dealer WHERE id=$id");
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Dealers</h2>
						<h3 class="page-title">add dealer</h3>
						<form method="post" action="dealercon.php" >
...
<div>
	...
	if (!empty($search)) {
		$query = "SELECT * FROM dealer WHERE name LIKE '%".$search."%'";
...
<table>
	...
	<?php while ($row = mysqli_fetch_array($results)) { ?>
		<tr>
			...
			<td>
				<a href="dealercon.php?del=<?php echo $row['id']; ?>" class="del_btn">Delete</a>
			</td>
		</tr>
	<?php } ?>
</table>
